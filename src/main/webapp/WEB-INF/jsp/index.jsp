...
<html>
    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                <h1 class="section-heading text-uppercase">Social Media</h1>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    <a href="https://smartstore.naver.com/mizangwonbytaehyun" target="_blank " class="text-white">
                        ...
                        <h3 class="my-3 roboto text-black">SmartStore</h3>
                        미장원by태현 SmartStore
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="https://www.youtube.com/channel/UCLZSItuQZ1B_iJa-r3mm2aw" target="_blank " class="text-white">
                        <span class="fa-stack fa-4x">
                            <svg class="svg-inline--fa fa-circle fa-stack-2x text-black-50" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512z"></path></svg><!-- <i class="fas fa-circle fa-stack-2x text-primary"></i> Font Awesome fontawesome.com -->
                        ...
                        <h3 class="my-3 roboto text-black">Youtube</h3>
                        미장원by태현 Youtube
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="https://www.instagram.com/mizangwonbytaehyun/" target="_blank " class="text-white">
                        <span class="fa-stack fa-4x">
                            <svg class="svg-inline--fa fa-circle fa-stack-2x text-black-50" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512z"></path></svg><!-- <i class="fas fa-circle fa-stack-2x text-primary"></i> Font Awesome fontawesome.com -->
                        ...
                        <h3 class="my-3 roboto text-black">Instagram</h3>
                        미장원by태현 Instagram
                    </a>
                </div>
            </div>
    ...
    <section class="page-section" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h1 class="section-heading text-uppercase">YOUTUBE</h1>
            </div>
            <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        <a href="https://www.youtube.com/watch?v=${video.id.videoId}" target="_blank">
                            <div class="video_thumbnail">
                                ...
                                <p class="video_title text-white">${video.title}</p>
                            </div>
                        </a>
                    </div>
                </c:forEach>
